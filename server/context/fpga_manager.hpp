  ...
  public:
    ...
    : ctx(ctx_)
    {
        ...
        if (exists_fs(fmanager_flags))
        {
            ...
            // copy new binaries
            fs::copy_file(live_instrument_dirname + "pl.dtbo", lib_firmware_dirname + 
                "/pl.dtbo", fs::copy_options::overwrite_existing);
            fs::copy_file(live_instrument_dirname + instrument_name + bit_extension, 
                lib_firmware_dirname + instrument_name + bit_extension, 
