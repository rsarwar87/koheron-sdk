...
# bank 12
# -------------------------------------------------------------------------------------------------
set_property PACKAGE_PIN W13 [get_ports IIC_0_scl_io]
set_property PACKAGE_PIN Y13 [get_ports IIC_0_sda_io]
...
set_property PACKAGE_PIN K10 [get_ports I2C_INT_N[0]]
set_property IOSTANDARD LVCMOS18 [get_ports I2C_INT_N[0]]

set_property PACKAGE_PIN G9 [get_ports DDR3_reset_n]
set_property IOSTANDARD LVCMOS18 [get_ports DDR3_reset_n]

set_property PACKAGE_PIN K11 [get_ports ETH0_INT_N_PL[0]]
set_property IOSTANDARD LVCMOS18 [get_ports ETH0_INT_N_PL[0]]
