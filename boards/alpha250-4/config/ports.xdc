...
set_property PACKAGE_PIN N18 [get_ports adc1_clk_in_clk_p]
set_property PACKAGE_PIN P19 [get_ports adc1_clk_in_clk_n]
...
set_property PACKAGE_PIN N20 [get_ports {adc1_1_p[2]}]
set_property PACKAGE_PIN P20 [get_ports {adc1_1_n[2]}]
...
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports {clk_gen_out_p[0]}]

set_property PACKAGE_PIN U18 [get_ports clk_gen_in_clk_p]
set_property PACKAGE_PIN U19 [get_ports clk_gen_in_clk_n]

set_property PACKAGE_PIN U14 [get_ports {clk_gen_out_p[0]}]
set_property PACKAGE_PIN U15 [get_ports {clk_gen_out_n[0]}]
...
set_property PACKAGE_PIN U12 [get_ports {spi_cfg_cs_rf_adc0[0]}]
set_property PACKAGE_PIN V16 [get_ports {spi_cfg_cs_rf_adc1[0]}]
set_property PACKAGE_PIN T12 [get_ports {spi_cfg_cs_clk_gen[0]}]
...
set_property PACKAGE_PIN J14 [get_ports {exp_io_0_n[0]}]
set_property PACKAGE_PIN K14 [get_ports exp_io_0_p]
set_property PACKAGE_PIN L15 [get_ports {exp_io_1_n[0]}]
set_property PACKAGE_PIN L14 [get_ports exp_io_1_p]
set_property PACKAGE_PIN M15 [get_ports {exp_io_2_n[0]}]
set_property PACKAGE_PIN M14 [get_ports exp_io_2_p]
set_property PACKAGE_PIN J19 [get_ports {exp_io_3_n[0]}]
set_property PACKAGE_PIN K19 [get_ports exp_io_3_p]
set_property PACKAGE_PIN L20 [get_ports {exp_io_4_n[0]}]
set_property PACKAGE_PIN L19 [get_ports exp_io_4_p]
set_property PACKAGE_PIN H17 [get_ports {exp_io_5_n[0]}]
set_property PACKAGE_PIN H16 [get_ports exp_io_5_p]
set_property PACKAGE_PIN M20 [get_ports {exp_io_6_n[0]}]
set_property PACKAGE_PIN M19 [get_ports exp_io_6_p]
set_property PACKAGE_PIN N16 [get_ports {exp_io_7_n[0]}]
set_property PACKAGE_PIN N15 [get_ports exp_io_7_p]
