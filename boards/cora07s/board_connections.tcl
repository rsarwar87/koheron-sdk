  ...
  set user_io_i [ create_bd_port -dir I -from 12 -to 0 user_io_i ]
  set user_io_o [ create_bd_port -dir O -from 12 -to 0 user_io_o ]
  set user_io_t [ create_bd_port -dir O -from 12 -to 0 user_io_t ]
